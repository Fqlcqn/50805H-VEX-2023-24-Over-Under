...
void auton_far_wp(){
  ...
  chassis.wait_drive();
  intake.set_value(false);
  chassis.set_drive_pid(20, 115, true);
  chassis.wait_drive();
  chassis.set_drive_pid(-8, 120, true);
  chassis.wait_drive();
  chassis.set_turn_pid(48.5, TURN_SPEED);
  chassis.wait_drive();
...
void drive_example(){
  ...
  chassis.wait_drive();
  chassis.set_drive_pid(27.5, 90, true);
  pros::delay(25);
  chassis.wait_drive();
  intake.set_value(true);
  pros::delay(30);
  ...
  chassis.wait_drive();
  chassis.set_drive_pid(44.5, 127, true);
  chassis.wait_drive();
  ...
  wings.set_value(true);
  pros::delay(30);
  chassis.set_swing_pid(ez::RIGHT_SWING, -270, SWING_SPEED);//DESCORE
  chassis.wait_drive();
  wings.set_value(false);
  pros::delay(30);
